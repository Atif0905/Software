      ...
      <div className=''>
        ...
        <div className='col-6 whiteback'>
          ...
          <form onSubmit={handleSubmit1}>
            ...
            <div className="form-group mt-3">
              <label htmlFor="description" className='ml'>Location</label><br/>
            ...
            <div className="form-group mt-3">
              <label htmlFor="totalLand" className="ml">Basic Rate</label><br/>
            ...
            <div className="form-group mt-3">
              <label htmlFor="totalLand" className="ml">Total Land</label><br/>
            ...
            <div className="form-group mt-3">
              <label htmlFor="GST" className="ml">Company Name</label><br/>
            ...
            <div className="form-group mt-3">
              <label htmlFor="GST" className="ml">GST Number</label><br/>
            ...
            <div className="form-group mt-3">
              <label htmlFor="AccountNo" className="ml">Account No</label><br/>
            ...
            <div className="form-group mt-3">
              <label htmlFor="Bank" className="ml">Bank Name</label><br/>
            ...
            <div className="form-group mt-3">
              <label htmlFor="IFSC" className="ml">IFSC</label><br/>
            ...
            <div className="form-group mt-3">
              <label htmlFor="Payable" className="ml">Payable At</label><br/>
            ...
            <div className="form-group mt-3">
              <label htmlFor="Posessionfinaldate" className="ml">Posession Final Date</label><br/>
