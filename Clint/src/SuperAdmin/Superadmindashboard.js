...
const Superadmindashboard = ({ projectsData, customersData, paymentDetailsData }) => {
  ...
  useEffect(() => {
    if (!projectsData || !paymentDetailsData || !customersData) {
      fetchData();
    }
  }, []);
  ...
  const fetchData = async () => {
    try {
      const [projects, paymentDetails, customers] = await Promise.all([
        fetchProjects(),
        fetchPaymentDetails(),
        fetchCustomers(),
      ]);
              ...
              <div className="paymentdiv2">
                <div className="payment-box1">
                  <div className="d-flex">
                    ...
                    <h6 className="paymenttext1">Total Payment</h6>
                  </div>
                ...
                <div className="payment-box1">
                  <div className="d-flex">
                    ...
                    <h6 className="paymenttext1">Received Payment</h6>
                  </div>
                ...
                <div className="payment-box1">
                  <div className="d-flex">
                    ...
                    <h6 className="paymenttext1">Due Payment</h6>
                  </div>
                ...
                <div className="payment-box1">
                  <div className="d-flex">
                    ...
                    <h6 className="paymenttext1">Total Customers</h6>
                  </div>
              ...
              <div className="">
                <div className="payment-box1 mt-3">
                  <div className="d-flex">
                    ...
                    <h6 className="paymenttext1">Total Projects</h6>
                  </div>
                ...
                <AreaChart data={paymentDataByDate}>
                  <defs>
                    <linearGradient id="colorUv" x1="0" y1="0" x2="0" y2="1">
                      <stop
                        offset="0%"
                        stopColor="rgba(162, 128, 255, 0.32)"
                        stopOpacity={1}
                      />
                      <stop
                        offset="100%"
                        stopColor="rgba(162, 128, 255, 0)"
                        stopOpacity={0}
                      />
                    </linearGradient>
                  </defs>
              ...
              {projects.map((project, Index) => (
                <div key={Index}>
                  <div className="dashboardprojectsec">
                    <GoProjectRoadmap className="projecticon" />
                    <p className="dashboardprojecttext">
