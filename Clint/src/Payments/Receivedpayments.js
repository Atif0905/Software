...
const Receivedpayments = () => {
            ...
            (installment, index) => {
              ...
              const amount =
                ...
                (parseFloat(unitDetails.totalPrice) -
                  (parseFloat(unitDetails.plcCharges) +
                    parseFloat(unitDetails.idcCharges) +
                    parseFloat(unitDetails.edcPrice)) *
                    parseFloat(unitDetails.plotSize));
              return {
  ...
  const possessionPayments = filteredPayments.filter(
    (payment) =>
      payment.paymentType === `Possession Charges - ${possessionCharges}`
  );
          ...
          <div className="formback2 mt-3">
            ...
            <div className="p-2">
              <h4 className="Headtext1">
                ...
                {customerDetails.mobileNumber} , unitPrice :{" "}
                {unitData.totalPrice}
              </h4>
            </div>
          </div>
                  ...
                  <form onSubmit={handleSubmit1}>
                    ...
                    >
                      ...
                      {customerDetails?.Duedates?.map((due, index) => {
                        ...
                        const paymentAmount = matchingPayments.reduce(
