  ...
  return (
    <div className='main-content '>
      ...
      {showPaymentForm && (
        ...
        <h4 className='Headtext1'>Name: {customerDetails.name}, Adhar Number: {customerDetails.aadharNumber} </h4>
        <div className='d-flex justify-content-between'>
          <div className='col-3 whiteback mt-4'>
            <form>
              <label> Select Payment</label>
              <select className='select-buttons ps-1' >
              ...
              <label>Cheque/ Reciept/ no.</label>
              <input type='text' className='form-input-field'/>
              <label>Comment</label>
              <input type='text' className='form-input-field' placeholder='Enter comment Regarding Payment'/>
