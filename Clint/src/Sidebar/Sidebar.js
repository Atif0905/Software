      ...
      <div className="side">
        ...
        <div className="mt-3">
          ...
          <div className="dropdown">
            ...
            >
              <AiOutlineFundProjectionScreen className="svg-icon" /> Project
              Master <IoIosArrowDown />
            </div>
            {/* AllProjects */}
            <div
              className={`dropdown-menu ${
                activeDropdown === "projectMaster" ||
                isDropdownActive([
                  "/AllProjects",
                  "/Projects",
                  "/Addblock",
            ...
            >
              ...
              <Link to="/Addblock">
                <li
                  className={`dropdown-item ${
                    location.pathname === "/Addblock" ? "active" : ""
                  }`}
                >
                  Add Block
                </li>
              ...
              <Link to="/Addunit">
                <li
                  className={`dropdown-item ${
                    location.pathname === "/Addunit" ? "active" : ""
                  }`}
                >
                  Add Unit
                </li>
          ...
          <div className="dropdown">
            ...
            >
              <RiSecurePaymentLine className="svg-icon" /> Payment Plan{" "}
              <IoIosArrowDown />
            </div>
            <div
              className={`dropdown-menu ${
                activeDropdown === "paymentPlan" ||
                isDropdownActive(["/Addplan", "/ViewPlan"])
                  ? "active"
                  : ""
              }`}
            >
              <Link to="/Addplan">
                <li
                  className={`dropdown-item ${
                    location.pathname === "/Addplan" ? "active" : ""
                  }`}
                >
                  Add Plan
                </li>
              ...
              <Link to="/ViewPlan">
                <li
                  className={`dropdown-item ${
                    location.pathname === "/ViewPlan" ? "active" : ""
                  }`}
                >
                  View Plan
                </li>
          ...
          <div className="dropdown">
            ...
            <div
              className={`dropdown-menu ${
                ...
                isDropdownActive(["/Addcustomer", "/ViewCustomer"])
                  ? "active"
                  : ""
              }`}
            >
              <Link to="/Addcustomer">
                <li
                  className={`dropdown-item ${
                    location.pathname === "/Addcustomer" ? "active" : ""
                  }`}
                >
                  Add Customer
                </li>
              ...
              <Link to="/ViewCustomer">
                <li
                  className={`dropdown-item ${
                    location.pathname === "/ViewCustomer" ? "active" : ""
                  }`}
                >
                  View Customer
                </li>
          ...
          <div className="dropdown">
            ...
            >
              <MdOutlinePayments className="svg-icon" /> Payment{" "}
              <IoIosArrowDown />
            </div>
            <div
              className={`dropdown-menu ${
                activeDropdown === "Payments" ||
                isDropdownActive(["/ReceivedPayments", "/Return-Payment"])
                  ? "active"
                  : ""
              }`}
            >
              <Link to="/ReceivedPayments">
                <li
                  className={`dropdown-item ${
                    location.pathname === "/ReceivedPayments" ? "active" : ""
                  }`}
                >
                  Received Payment
                </li>
              ...
              <Link to="/Return-Payment">
                <li
                  className={`dropdown-item ${
                    location.pathname === "/Return-Payment" ? "active" : ""
                  }`}
                >
                  Return Payment
                </li>
          ...
          <Link to="/CancelUnit">
            <div
              className={`Sidelink ${
                location.pathname === "/CancelUnit" ? "active" : ""
              }`}
            >
          ...
          <div className="dropdown">
            ...
            <div
              className={`dropdown-menu ${
                activeDropdown === "Ass" ||
                isDropdownActive(["/Register-User-Admin", "/AssgProject"])
                  ? "active"
                  : ""
              }`}
            >
              <Link to="/Register-User-Admin">
                <li
                  className={`dropdown-item ${
                    location.pathname === "/Register-User-Admin" ? "active" : ""
                  }`}
                >
                  Assign Project
                </li>
          ...
          <Link to="/Admin-Hold-History">
            <div
              className={`Sidelink ${
                location.pathname === "/Admin-Hold-History" ? "active" : ""
              }`}
            >
