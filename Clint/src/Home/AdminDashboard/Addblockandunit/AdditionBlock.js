    ...
    <div className="main-content back">
      ...
      <div className='col-6 whiteback'>
        <form onSubmit={handleAddBlock}>
          ...
          <input type="number" className="form-input-field " placeholder="Total Plot in Block" value={totalPlotInBlock} onChange={(e) => setTotalPlotInBlock(e.target.value)} required />
          <div className='mt-2'>
            <label className=''>Plot Size</label>
            <input type="number" className="form-input-field" placeholder="Plot Size (sqyd)" value={plotSize} onChange={(e) => setPlotSize(e.target.value)} required/>
          </div>
          <div className='mt-2'>
            <label className=''>Basic Rate</label>
            <input type="number" className="form-input-field" placeholder="Basic Rate of Block" value={basicRateOfBlock} onChange={(e) => setBasicRateOfBlock(e.target.value)} required
            />
          </div>
          <div className='mt-2'>
            <label className=''>IDC Rate</label>
            <input type="number" className="form-input-field " placeholder="IDC rate of Block" value={idcRateOfBlock} onChange={(e) => setIdcRateOfBlock(e.target.value)} required/>
          </div>
          <div className='mt-2'>
            <label className=''>EDC Rate</label>
            <input type="number" className="form-input-field " placeholder="EDC Rate of Block" value={edcRateOfBlock} onChange={(e) => setEdcRateOfBlock(e.target.value)} required/>
          </div>
          <button type="submit" className="add-buttons mt-3"> Add Block </button>
        </form>
      </div>
    </div>
  );
